...
import 'package:tembelea_goma/pages/tourists_login.dart';
...
class RegisterTouristPage extends StatefulWidget {
  @override
  _RegisterTouristPageState createState() => _RegisterTouristPageState();
}
...
class _RegisterTouristPageState extends State<RegisterTouristPage> {
  ...
  void _signUp() async {
    ...
    try {
      // Simulating a delay for signup process
